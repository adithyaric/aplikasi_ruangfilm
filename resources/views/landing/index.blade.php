    ...
    <nav
        ...
        <div
            ...
            <div class="hidden md:flex items-center space-x-8 text-sm font-medium">
                <a
                    href="/"
                    class="nav-link text-purple-300 font-semibold hover:text-purple-300 transition">Home</a>
                <a
                    href="/program"
    ...
    <main class="relative z-10">
        ...
        <section
            ...
            <div
                ...
                <!-- Garis Pemisah + CTA Area -->
                <div class="mt-12 pt-10 border-t border-purple-500/20">
                    <!-- Counter Section -->
                    <div class="text-center space-y-4">
                        <!-- Angka Counter -->
                        @php
                        $jumlahPeserta = \App\Models\User::where('role', 'peserta')->count() * 2;
                        @endphp
                        ...
                        <div class="text-5xl md:text-7xl font-black bg-gradient-to-r from-purple-400 via-fuchsia-400 to-purple-300 bg-clip-text text-transparent">
                            <span
                                ...
                                class="counter-value"
                                data-target="{{ $jumlahPeserta }}">0</span>+
                        </div>
                        <!-- Label -->
                        <p
                            class="text-gray-300 text-sm md:text-base uppercase tracking-wider font-medium">
                            Film Submitted
                        </p>
                        ...
                        <div class="flex justify-center mt-6">
                            <div
                                class="w-20 h-[2px] bg-gradient-to-r from-transparent via-purple-500 to-transparent"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- ================================================== -->
        <section
            class="max-w-7xl mx-auto px-6 md:px-10 py-24 md:py-28 merchandise-section">
            <!-- Header Section dengan fade-up -->
            <div class="fade-up">
                <p
                    class="text-purple-400 text-sm md:text-base uppercase tracking-wider font-semibold mb-2">
            ...
            <div
                class="glass-card mt-12 rounded-3xl p-6 md:p-8 lg:p-10 fade-up transition-all duration-500 hover:shadow-[0_0_30px_rgba(109,40,217,0.2)]">
                <!-- Grid Merchandise: 3x2 desktop, 2 tablet, 1 mobile -->
                <div
                    class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-7">
                    <!-- CARD TEMPLATE (ulangi untuk setiap produk) -->
                    <div class="group merchandise-card transition-all duration-500">
                        <div class="glass-card-light rounded-2xl overflow-hidden transition-all duration-500 group-hover:scale-[1.03] group-hover:-translate-y-2 group-hover:shadow-[0_0_25px_#6D28D9] h-full flex flex-col">
                            ...
                            <div class="relative w-full overflow-hidden bg-gradient-to-br from-purple-900/30 to-black/50" style="height: 200px;">
                                <img src="{{ asset('landing/images/merchan/merchan1.jpg') }}"
                                    alt="Nama Produk"
                            ...
                            <div class="p-5 flex flex-col flex-grow gap-3">
                                <div>
                                    <h3 class="text-base md:text-lg font-bold text-white group-hover:text-purple-300 transition-colors duration-300 leading-snug">
                                        Nama Produk
                                    </h3>
                                </div>
                                ...
                                <div class="flex items-baseline gap-2">
                                    <span class="text-purple-400 text-lg font-bold">Rp 120.000</span>
                                    {{-- Harga coret opsional --}}
                                    <span class="text-gray-500 text-sm line-through">Rp 150.000</span>
                                </div>
                                ...
                                <div class="flex gap-2 mt-auto">
                                    ...
                                    <button
                                        ...
                                        class="flex-none w-10 h-10 rounded-xl border border-purple-500/40 bg-purple-500/10 text-purple-400 hover:bg-purple-500/25 transition-colors duration-200 flex items-center justify-center">
                ...
                <div class="mt-12 pt-10 border-t border-purple-500/20">
                    <div class="text-center">
                        ...
                        <p class="text-gray-500 text-xs mt-5">
                            *Limited stock available. Pre-order now to secure your item.
                        </p>
                    </div>
                </div>
            </div>
