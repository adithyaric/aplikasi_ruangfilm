...
@section('main')
    <main class="relative z-10">
        ...
        <section
            ...
            <!-- SYARAT & KETENTUAN LENGKAP (Langsung ditampilkan) -->
            <div class="fade-up mt-10">
                <div
                    class="glass-card rounded-3xl p-6 md:p-8 lg:p-10 transition-all duration-500">
                        ...
                        <ul class="space-y-3 text-gray-300 text-sm md:text-base">
                            ...
                            <li class="flex items-start gap-3">
                                <i
                                    ...
                                    desa/kecamatan diseluruh Kabupaten Pacitan</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i
                                    class="fas fa-check-circle text-purple-400 mt-1 text-sm"></i><span>Peserta merupakan anggota komunitas lokal Pacitan</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i
                            ...
                            <li class="flex items-start gap-3">
                                <i
                                    class="fas fa-check-circle text-purple-400 mt-1 text-sm"></i><span>Setiap tim wajib mengirimkan minimal 1 karya, dan
                                    diperbolehkan mengirim lebih dari 1 karya.</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i
                                    class="fas fa-check-circle text-purple-400 mt-1 text-sm"></i><span>Konten film harus memiliki alur cerita dan pesan moral yang
                                    mudah dipahami oleh penonton, termasuk kalangan ibu-ibu
                                    PKK.</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i
                                    class="fas fa-check-circle text-purple-400 mt-1 text-sm"></i><span>Peserta bersedia mengikuti seluruh rangkaian kegiatan dan
                                    screening film sesuai ketentuan panitia FFH 2026.</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i
                                    class="fas fa-check-circle text-purple-400 mt-1 text-sm"></i><span>Karya tidak boleh mengandung unsur SARA, pornografi, atau
                                    konten negatif lainnya.</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i
                                    class="fas fa-check-circle text-purple-400 mt-1 text-sm"></i><span>Tidak diperbolehkan menggunakan musik atau sound yang
                                    mengandung copyright. Musik bebas hak cipta (free copyright)
                                    diperbolehkan.</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i
                                    class="fas fa-check-circle text-purple-400 mt-1 text-sm"></i><span>Dilarang menampilkan properti berupa minuman keras dan
                                    rokok yang memperlihatkan merek (brand) secara jelas.</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i
                    ...
                    <div
                        ...
                        <ul class="space-y-3 text-gray-300 text-sm md:text-base">
                            <li class="flex items-start gap-3">
                                <i class="fas fa-file-alt text-purple-400 mt-1 text-sm"></i>
                                <span>Sinopsis film singkat maksimal 300 kata</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i class="fas fa-video text-purple-400 mt-1 text-sm"></i>
                                <span>Trailer film (maksimal 2 menit)</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i class="fas fa-image text-purple-400 mt-1 text-sm"></i>
                                <span>Poster film JPEG/PNG minimal 1500x2000 px</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i class="fas fa-camera text-purple-400 mt-1 text-sm"></i>
                                <span>Minimal 5 foto proses produksi film atau cuplikan film
                                    (still image)</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i class="fas fa-users text-purple-400 mt-1 text-sm"></i>
                                <span>Data singkat tim produksi, meliputi:
                                    <br />
                                    - Produser <br />
                                    - Sutradara <br />
                                    - Kru Produksi
            ...
            <div class="mt-12 text-center fade-up">
                ...
                <div class="glass-card-light rounded-3xl p-6 md:p-8">
                    <div class="flex flex-col sm:flex-row gap-5 justify-center items-center">
                        ...
                        <a href="{{ asset('landing/pdf/ffh-komunitas.pdf') }}" download=" Petunjuk_Teknis_FFH_Organisasi.pdf"
